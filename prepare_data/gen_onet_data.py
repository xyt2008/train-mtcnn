...
neg_save_dir = "%s/prepare_data/48/negative"%config.root
pos_save_dir = "%s/prepare_data/48/positive"%config.root
part_save_dir = "%s/prepare_data/48/part"%config.root

save_dir = "%s/prepare_data/onet"%config.root
